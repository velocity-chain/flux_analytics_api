...
- Developer [API Standard Prerequisites](https://github.com/velocity-chain/flux/blob/main/DeveloperEdition/standards/api_standards.md)
...
## run api server in dev mode - captures command line, serves API at localhost:8397
pipenv run dev
...
```bash
# Get a token
export TOKEN=$(curl -s -X POST http://localhost:8397/dev-login \
